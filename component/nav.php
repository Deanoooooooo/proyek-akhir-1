  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:14vw; height:7vh; padding-top:0px;" alt="Brand" src="asset/img/logotoko.png">
      </a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right" >
      <li>
        <?php 
          $conn = mysqli_connect('localhost', 'root', '', 'toko-sport');
          if(isset($_SESSION['idUser'])){
            ...
            echo '
                <a href="proses/logout.php"><button class="btn navbar-btn" id="btn-logout" style="color:#808080;margin-top:-0.8vh;
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:14vw; height:7vh; padding-top:2vh;" alt="Brand" src="asset/img/logotoko.png"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        ...
        <li><a data-toggle="pill" href="#couple">Aksesoris</a></li>
        <li><a data-toggle="pill" href="#anak" >Anak-anak</a></li>
        <li><a data-toggle="pill" href="#sarimbit">Alat Olahraga</a></li>
      </ul>
    </div>
  </div>
</div>
