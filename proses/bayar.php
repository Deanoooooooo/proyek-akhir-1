<?php 
  ...
  if($query){
    echo '
      <script>
      alert("Terima Kasih sudah Berbelanja, Silahkan Tranfer ke Rekening BRI 5514-0684-0000. Denil adriano. Barang anda akan segera kami kirim setelah pembayaran dilakukan. Semoga anda nyaman dengan layanan kami CHUAKSSS.!");
